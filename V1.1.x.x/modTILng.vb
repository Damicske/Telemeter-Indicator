        ...
        Select Case frmName
            Case "frmSettings"
                With frmSettings
                    ...
                    .mnuMobile.Text = "Toon &mobiel"
                    .mnuMobile.ToolTipText = "Toon je mobiele abbonementen en hun verbruik"
                    ...
                    .mnuMijnTelenetConnecties.Text = "Modem verbi&ndingen"
                    ...
                    .mnuSettingsShowMyTelenet.ToolTipText = "Toon de meldingen van Telenet"
                    ...
                    .mnuSettingsSaveLog.Text = "Logboek opslaan"
                    .mnuSettingsSaveLog.ToolTipText = "Sla het logboek op in de database"
                    ...
                    .mnuSettingsUpdAuto.Text = "&Update automatisch"
                    .mnuSettingsUpdAuto.ToolTipText = "Update autmatisch als er een nieuwe versie is gevonden"
                    .mnuSettingsShowBalloon.Text = "Toon b&allon meldingen"
                    .mnuSettingsShowBalloon.ToolTipText = "Toon programma meldingen"
                    .mnuSettingsDataSend.Text = "Zend Telenet pagina"
                    .mnuSettingsDataSend.ToolTipText = "Zend Telenet pagina data naar CD-PC"
                    .mnuSettingsBeta.Text = "Controleer op beta versie's"
                    .mnuSettingsBeta.ToolTipText = "Controleer op beta versie's"

                    .mnuSettingsDataSavedData.Text = "Opgeslagen data"
                    .mnuSettingsDataSavedData.ToolTipText = "Ga naar de opgeslagen gegevens map"
                    .mnuSettingsDataImport.Text = "Importeer oude data"
                    .mnuSettingsDataImport.ToolTipText = "Importeer je oude verbruiks data"
                ...
                OtherText(8) = "Er is een nieuwe versie gevonden, wil je die nu isntalleren of liever wachten?"
            ...
            Case "frmLog"
                With frmLog
                    .Text = "Logboek"
                    .btnFilterApply.Text = "Filter"
                    .chkShowErr.Text = "Toon fouten"
                    .ChkShowHtml.Text = "Toon HTML"
                    .chkShowDbg.Text = "Toon debug info"
                    .lvLog.Columns(0).Text = "Datum tijd"
                    .lvLog.Columns(1).Text = "Bericht"
                    .cmsColorLine.Text = "K&leur de lijnen"
                    .cmsCopyLine.Text = "&Kopieer de lijn(en)"
                    .cmsFilter.Text = "&Filter"
                End With

            Case "frmConnections"
                With frmConnections
                    .Text = "Verbindingen"
                    .lvCons.Columns(0).Text = "MAC Adres"
                    .lvCons.Columns(1).Text = "IPv4"
                    .lvCons.Columns(2).Text = "IPv6"
                    .lvCons.Columns(3).Text = "Naam"
                    .lvCons.Columns(4).Text = "Connectie"
                End With

            Case "frmMobile"
                With frmMobile
                    .Text = "Mobiel verbruik"
                    .lvData.Columns(0).Text = "Telefoonnummer"
                    .lvData.Columns(1).Text = "Abonnement"
                    .lvData.Columns(2).Text = "Limiet"
                    .lvData.Columns(3).Text = "Verbruik"
                End With
        End Select
    End Sub
        ...
        Select Case frmName
            Case "frmSettings"
                With frmSettings
                    ...
                    .mnuMobile.Text = "Show &mobile"
                    .mnuMobile.ToolTipText = "Show your mobile usage"
                    ...
                    .mnuMijnTelenetConnecties.Text = "Modem co&nnections"
                    ...
                    .mnuSettingsShowMyTelenet.ToolTipText = "Show the last My Telenet announcements"
                    ...
                    .mnuSettingsSaveLog.Text = "Save Logbook"
                    .mnuSettingsSaveLog.ToolTipText = "Save the logbook in the database"
                    ...
                    .mnuSettingsUpdAuto.Text = "Update automaticly"
                    .mnuSettingsUpdAuto.ToolTipText = "Update automaticly if a new version is found"
                    .mnuSettingsShowBalloon.Text = "Show b&alloon notifications"
                    .mnuSettingsShowBalloon.ToolTipText = "Show program balloon notifications"
                    .mnuSettingsBeta.Text = "Check for beta updates"
                    .mnuSettingsBeta.ToolTipText = "Check for beta updates"
                    .mnuSettingsDataImport.Text = "Import old data"
                    .mnuSettingsDataImport.ToolTipText = "Import your old usage data"
                    ...
                    .mnuSettingsDataSavedData.Text = "Saved data"
                    .mnuSettingsDataSavedData.ToolTipText = "Go to the saved data folder"
                ...
                OtherText(8) = "There is a new version found, you want to install it now or rather wait?"
            ...
            Case "frmLog"
                With frmLog
                    .Text = "Logbook"
                    .btnFilterApply.Text = "Filter"
                    .chkShowErr.Text = "Show errors"
                    .ChkShowHtml.Text = "Show HTML"
                    .chkShowDbg.Text = "Show debug info"
                    .lvLog.Columns(0).Text = "Date time"
                    .lvLog.Columns(1).Text = "Message"
                    .cmsColorLine.Text = "Co&lor the lines"
                    .cmsCopyLine.Text = "&Copy the lines"
                    .cmsFilter.Text = "&Filter"
                End With
            ...
            Case "frmConnections"
                With frmConnections
                    .Text = "Connections"
                    .lvCons.Columns(0).Text = "MAC Adress"
                    .lvCons.Columns(1).Text = "IPv4"
                    .lvCons.Columns(2).Text = "IPv6"
                    .lvCons.Columns(3).Text = "Name"
                    .lvCons.Columns(4).Text = "Connection"
                End With

            Case "frmMobile"
                With frmMobile
                    .Text = "Mobile usage"
                    .lvData.Columns(0).Text = "Phonenumber"
                    .lvData.Columns(1).Text = "Abonnment"
                    .lvData.Columns(2).Text = "Limit"
                    .lvData.Columns(3).Text = "Usage"
                End With
        End Select
    End Sub
        ...
        Select Case frmName
            Case "frmSettings"
                With frmSettings
                    ...
                    .mnuMobile.Text = "Afficher l'utilisation &mobile"
                    .mnuMobile.ToolTipText = "Afficher l'utilisation mobile"
                    ...
                    .mnuMijnTelenetMention.ToolTipText = "Voir le dernier message Mon Telenet"
                    .mnuMijnTelenetConnecties.Text = "Co&nnexions de modem"
                    ...
                    .mnuSettingsSaveLog.Text = "Enregistrer le journal"
                    .mnuSettingsSaveLog.ToolTipText = "Enregistrez le journal dans un database"
                    ...
                    .mnuSettingsUpdAuto.Text = "Mettre à jour automatiquement"
                    .mnuSettingsUpdAuto.ToolTipText = "Mettre à jour automatiquement quand une nouvelle version est trouvée"
                    .mnuSettingsShowBalloon.Text = "Afficher les notifications de b&allon"
                    .mnuSettingsShowBalloon.ToolTipText = "Afficher les notifications de bulle de programme"
                    .mnuSettingsBeta.Text = "Vérifier les mises à jour des bêta"
                    .mnuSettingsBeta.ToolTipText = "Vérifier les mises à jour des bêta"
                    .mnuSettingsDataImport.Text = "Importer des données anciennes"
                    .mnuSettingsDataImport.ToolTipText = "Importez vos anciennes données consommables."
                    ...
                    .mnuSettingsDataSavedData.Text = "Les données stockées."
                    .mnuSettingsDataSavedData.ToolTipText = "Allez dans le dossier de données stockées"
                ...
                OtherText(8) = "A trouvé une nouvelle version, vous allez maintenant installer supplémentaires ou plutôt attendre?"
            ...
            Case "frmLog"
                With frmLog
                    .Text = "le journal"
                    .btnFilterApply.Text = "filtre"
                    .chkShowErr.Text = "Afficher les erreurs"
                    .ChkShowHtml.Text = "Voir le HTML"
                    .chkShowDbg.Text = "Afficher les informations de débogage"
                    .lvLog.Columns(0).Text = "Date Heure"
                    .lvLog.Columns(1).Text = "Message"
                    .cmsColorLine.Text = "&Lignes de couleur"
                    .cmsCopyLine.Text = "&Copier la ligne(s)"
                    .cmsFilter.Text = "&filtre"
                End With

            Case "frmConnections"
                With frmConnections
                    .Text = "Connexions"
                    .lvCons.Columns(0).Text = "MAC Adresse"
                    .lvCons.Columns(1).Text = "IPv4"
                    .lvCons.Columns(2).Text = "IPv6"
                    .lvCons.Columns(3).Text = "Nom"
                    .lvCons.Columns(4).Text = "Connexion"
                End With

            Case "frmMobile"
                With frmMobile
                    .Text = "Mobiel verbruik"
                    .lvData.Columns(0).Text = "numéro de téléphone"
                    .lvData.Columns(1).Text = "Abonnement"
                    .lvData.Columns(2).Text = "Limite"
                    .lvData.Columns(3).Text = "Consommation"
                End With
        End Select
    End Sub
        ...
        Select Case frnName
            Case "frmSettings"
                With frmSettings
                    ...
                    .mnuMobile.Text = "Zeigen Sie den &mobilen Einsatz"
                    .mnuMobile.ToolTipText = "Zeigen Sie den mobilen Einsatz"
                    ...
                    .mnuMijnTelenetConnecties.Text = "Modem Verbi&ndungen"
                    .mnuMijnTelenetConnecties.ToolTipText = "Die Modem-DHCP-Verbindungen anzeigen"
                    .mnuSettings.Text = "Anzeigeein&stellungen"
                    .mnuSettingsShowMyTelenet.Text = "Zeigen Sie Ihr Telenet Berichte"
                    .mnuSettingsShowMyTelenet.ToolTipText = "Zeige die letzten Mein Telenet Erwähnung"
                    ...
                    .mnuSettingsSaveLog.ToolTipText = "Speichern Sie das Protokoll in einer Datei"
                    ...
                    .mnuSettingsUpdAuto.Text = "Automatisch aktualisiert"
                    .mnuSettingsUpdAuto.ToolTipText = "Aktualisieren Sie automatisch, wenn eine neue Version gefunden"
                    .mnuSettingsShowBalloon.Text = "Zeige B&allon-Benachrichtigungen"
                    .mnuSettingsShowBalloon.ToolTipText = "Showprogramm Blase Benachrichtigungen"
                    .mnuSettingsBeta.Text = "Auf Beta-Updates prüfen"
                    .mnuSettingsBeta.ToolTipText = "Auf Beta-Updates prüfen"
                    .mnuSettingsDataImport.Text = "Importieren Sie alte Daten"
                    .mnuSettingsDataImport.ToolTipText = "Importieren Sie Ihre alten Verbrauchsdaten."
                    ...
                    .mnuSettingsDataSavedData.Text = "Die gespeicherten Daten"
                    .mnuSettingsDataSavedData.ToolTipText = "Gehen Sie auf die gespeicherten Daten Ordner"
                ...
                OtherText(7) = "Wireless"
                OtherText(8) = "Hat eine neue Version gefunden, werden Sie nun zusätzliche Installation oder lieber warten?"
            ...
            Case "frmLog"
                With frmLog
                    .Text = "Protokolle"
                    .btnFilterApply.Text = "Filter"
                    .chkShowErr.Text = "Fehler anzeigen"
                    .ChkShowHtml.Text = "Zeigen Sie HTML"
                    .chkShowDbg.Text = "Debug-Informationen anzeigen"
                    .lvLog.Columns(0).Text = "Date zeit"
                    .lvLog.Columns(1).Text = "Nachricht"
                    .cmsColorLine.Text = "Farbe den Zeilen"
                    .cmsCopyLine.Text = "Kopieren Sie die Zeile(n)"
                    .cmsFilter.Text = "Filter"
                End With
            ...
            Case "frmConnections"
                With frmConnections
                    ...
                    .lvCons.Columns(2).Text = "IPv6"
                    .lvCons.Columns(3).Text = "Name"
                    .lvCons.Columns(4).Text = "Verbindung"
                End With

            Case "frmMobile"
                With frmMobile
                    .Text = "Mobiel verbruik"
                    .lvData.Columns(0).Text = "Telefon"
                    .lvData.Columns(1).Text = "Abonnement"
                    .lvData.Columns(2).Text = "Limit"
                    .lvData.Columns(3).Text = "Der Verbrauch"
                End With
        End Select
    End Sub
End Module
